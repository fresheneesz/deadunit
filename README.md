...
var test = Unit.test('some test name', function(t) {
    ...
    this.test('nested test', function(t) {
        this.ok(obj.go() > 4)
    })
    ...
    try {
    	...
    	this.eq(e.message, 'oops') // expect the exception
    }
...
* 5.2.1 - Removing shrinkwrap file, which was blocking updated libraries (ugh)
